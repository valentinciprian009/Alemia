...
int main()
{
    ...
    EcranLogare::getInstance()->DisplayTitleScreen();
    EcranLogare::getInstance()->getLogs();
    EcranLogare::getInstance()->DestroyInstance();
    ...
    Teren::getInstance()->DestroyInstance();
    ...
    Evenimente A("FisierEvenimente.txt");
