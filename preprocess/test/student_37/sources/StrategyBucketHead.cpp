...
StrategyBucketHead::StrategyBucketHead()
{
}
...
// TODO: remove code duplication (StrategyRegular)
bool StrategyBucketHead::execute_move(Zombie * zombie, int surface_number)
{
	...
	if (pozitie_zombie_curent > 0 && surface->get_plants_positions()[pozitie_zombie_curent - 1] != NULL) {
