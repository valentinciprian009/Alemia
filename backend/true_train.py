...
class Train:
    ...
    def train(self):
        ...
        joblib.dump(self.regressor, "weights.apt")

    def test(self, model_name = "weights.apt"): 
    ...
    def test_multiple_methods(self):
        ...
        print("RMSE Linear Regression: ", self._calculate_rmse(y_test, linear_predict))
        print("RMSE Random Forest: ", self._calculate_rmse(y_test, random_forest_predict))
...
class Predictor:
    ...
    def __init__(self, model_name = "weights.apt"):
...
# train.train()
# train.test()
# train.test_multiple_methods()

# Hot to use Predictor class
